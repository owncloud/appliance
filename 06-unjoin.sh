...
echo "[06.UNJOIN] Dropping ownCloud admin docs..." 2>&1 | tee --append /var/lib/univention-appcenter/apps/owncloud/data/files/owncloud-appcenter.log
...
echo "[06.UNJOIN] Dropping ownCloud user docs..." 2>&1 | tee --append /var/lib/univention-appcenter/apps/owncloud/data/files/owncloud-appcenter.log
...
echo "[06.UNJOIN] Dropping ownCloud database..." 2>&1 | tee --append /var/lib/univention-appcenter/apps/owncloud/data/files/owncloud-appcenter.log
mysql -u root -p$(cat /etc/mysql.secret) owncloud -e "DROP DATABASE IF EXISTS owncloud"

echo "[06.UNJOIN] removing owncloud.secret file"
